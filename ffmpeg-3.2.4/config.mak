...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libfreetype --enable-gpl --enable-libx264 --disable-ffprobe --disable-ffserver --disable-debug
prefix=/usr/local
...
CC_IDENT=gcc 4.8.2 (GCC) 20140120 (Red Hat 4.8.2-15)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread -I/usr/include/freetype2 -I/usr/local/include/SDL2 -D_REENTRANT  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
CFLAGS-ffplay=-I/usr/local/include/SDL2 -D_REENTRANT
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lXv -lX11 -lXext -ldl -lxcb -lxcb-shm -lxcb-xfixes -lxcb-shape -lX11 -lasound -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -lSDL2 -lfreetype -lm -llzma -lbz2 -lz -pthread -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
LIBS-ffplay=-L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -lSDL2
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
